...
%* Best practices for overriding Rice DD and Rice modules
%* Use of rice.xx.additionalSpringFiles
...
\begin{frame}[fragile]{Institutional Modification Best Practices}
  \begin{itemize}
    ...
    \item Use institution packages and namespaces instead of Kuali ones. For example,
      \begin{itemize}
        \item \texttt{com/rsmart/kuali/kra} instead of \texttt{org/kuali/kra}
        \item \texttt{com/rsmart/kuali/rice} \texttt{org/kuali/rice}
      \end{itemize}
